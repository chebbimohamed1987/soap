...
public class BanqueWsLocator extends org.apache.axis.client.Service implements mypackage.BanqueWs {
    ...
    private java.lang.String BanqueServicePort_address = "http://localhost:8081/";
    ...
    public mypackage.BanqueService getBanqueServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public mypackage.BanqueService getBanqueServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.BanqueServicePortBindingStub _stub = new mypackage.BanqueServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypackage.BanqueService.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.BanqueServicePortBindingStub _stub = new mypackage.BanqueServicePortBindingStub(new java.net.URL(BanqueServicePort_address), this);
                _stub.setPortName(getBanqueServicePortWSDDServiceName());
                return _stub;
            }
        }
